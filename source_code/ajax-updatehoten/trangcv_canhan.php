		...
		<div class="layer-3">
			...
			foreach ($result as  $document) {
				...
				<h2 style="position: relative;">
					...
					<!-- <input class="btn btn-primary" type="button" name="clickme" id="clickme" onclick="load_ajax()" value="Click Me" style="position: absolute; top: 5px; right: 5px; padding: 13px;"/> -->
				...
				<script>
					...
					// 	console.log('Tên mới cần update: '+newname);
					// 	alert( "Bạn vừa mới thay đổi Họ tên thành: "+ newname ); //show alert
					// 	$('#showname').append('<p class="alert alert-success" style="animation-delay: 0s; text-transform:uppercase; text-transform: none; role="alert">Bạn vừa mới thay đổi Họ tên thành :'+newname+'</p>'); //add html
