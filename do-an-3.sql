...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th1 02, 2019 lúc 06:01 AM
...
(9, 'ftt', 'tttt', NULL),
(10, '423', 'sdsa', NULL),
(11, 'tin tuyển dụng', 'fasfaf', NULL),
(12, 'Tuyển dụng Dev lương cao', 'Đây là nội dung chi tiết', NULL);
...
(3, 'Hè 2017', 'Nhóm tình nguyện hè xanh', 'Tham gia chiến dịch tình nguyện Mùa Hè Xanh', 3),
...
(1, '1997-01-20', 'nữ', 362323040, 'https://www.facebook.com/dangvui.123', 'Việt Nam', '../assets/img/2.jpg', 'Tôi là một chuyên gia tự do hoàn toàn tự do Sáng tạo Giao diện người dùng Nhà thiết kế và Nhà phát triển Liên quan với thiết kế web mới nhất và công nghệ là tuyệt vời cảm thấy liên lạc với sáng tạo.', 8, 'HTTT', 1),
(2, '1997-11-27', 'nữ', 985236478, 'https://www.facebook.com/phithi.ngocminh', 'Việt Nam', '../assets/img/1.jpg', 'Tôi là một chuyên gia tự do hoàn toàn tự do Sáng tạo Giao diện người dùng Nhà thiết kế và Nhà phát triển Liên quan với thiết kế web mới nhất và công nghệ là tuyệt vời cảm thấy liên lạc với sáng tạo.', 9, 'KHMT', 1),
(3, '1997-01-22', 'nữ', 376404446, 'https://www.facebook.com/lethidiemphuong0197', 'Việt Nam', '../assets/img/4.jpg', 'Tôi là một chuyên gia tự do hoàn toàn tự do Sáng tạo Giao diện người dùng Nhà thiết kế và Nhà phát triển Liên quan với thiết kế web mới nhất và công nghệ là tuyệt vời cảm thấy liên lạc với sáng tạo.', 7, 'KTPM', 1),
(4, '1997-09-19', 'nữ', 962739775, 'https://www.facebook.com/kaitran19', 'Việt Nam', '../assets/img/1.jpg', 'Tôi là một chuyên gia tự do hoàn toàn tự do Sáng tạo Giao diện người dùng Nhà thiết kế và Nhà phát triển Liên quan với thiết kế web mới nhất và công nghệ là tuyệt vời cảm thấy liên lạc với sáng tạo.', 6, 'KTPM', 1);
...
--
ALTER TABLE `dang_tt`
  MODIFY `id_tt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `user_ntd`
  MODIFY `id_ntd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
